...
class ConversationMeta(TypedDict, total=False):
    ...
    Attributes:
        scene: Scene type, supports "private" (human-human, one-on-one) or "group" (multi-party group chat) (optional)
        scene_desc: Scene description information, can contain owner_user_id / owner_user_name (optional)
...
def create_example_group_chat() -> GroupChatFormat:
    ...
    return {
        ...
        "conversation_meta": {
            ...
            "name": "Friends Weekend Plan Chat",
            "description": "Planning a weekend trip and sharing daily updates.",
            "group_id": "group_friends_weekend_2025",
