...
class MemorizeRequest:
    ...
    # Unified conversation identifier (new field). During migration it maps to group_id.
    conversation_id: Optional[str] = None
    group_id: Optional[str] = None
    group_name: Optional[str] = None
    current_time: Optional[datetime] = None
    force_profile_extraction: bool = False
    # Owner user ID for self-profile routing
    ...
    # Skip pending boundary confirmation (for historical imports)
    skip_pending_boundary: bool = False
