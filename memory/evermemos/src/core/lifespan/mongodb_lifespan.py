...
class MongoDBLifespanProvider(LifespanProvider):
    ...
    async def startup(self, app: FastAPI) -> Any:
        ...
        try:
            # Import document modules before scanning subclasses so Beanie sees them.
            import infra_layer.adapters.out.persistence.document  # noqa: F401
            import infra_layer.adapters.out.persistence.document.memory  # noqa: F401
