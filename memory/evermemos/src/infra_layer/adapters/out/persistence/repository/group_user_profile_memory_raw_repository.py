...
class GroupUserProfileMemoryRawRepository(BaseRepository[GroupUserProfileMemory]):
    ...
    def get_profile(self, memory: GroupUserProfileMemory) -> Dict[str, Any]:
        ...
        return {
            ...
            "way_of_decision_making": memory.way_of_decision_making,
            "life_habit_preference": getattr(memory, "life_habit_preference", None),
            "communication_style": getattr(memory, "communication_style", None),
            "catchphrase": getattr(memory, "catchphrase", None),
            "user_to_friend_catchphrase": getattr(
                memory, "user_to_friend_catchphrase", None
            ),
            "user_to_friend_chat_style_preference": getattr(
                memory, "user_to_friend_chat_style_preference", None
            ),
            "motivation_system": getattr(memory, "motivation_system", None),
            "fear_system": getattr(memory, "fear_system", None),
            "value_system": getattr(memory, "value_system", None),
            "humor_use": getattr(memory, "humor_use", None),
            "occupation": getattr(memory, "occupation", None),
            "gender": getattr(memory, "gender", None),
            "relationship": getattr(memory, "relationship", None),
        }
