...
class PromptManager:
    ...
    def clear_cache(self, module_path: Optional[str] = None):
        """Clear module cache to force reload of prompts.
...
def clear_prompt_cache(module_path: Optional[str] = None):
    ...
    Example:
        clear_prompt_cache()  # Clear all
        clear_prompt_cache("memory_layer.prompts.zh.profile_mem_part1_prompts")  # Clear specific
    """
    _prompt_manager.clear_cache(module_path)
