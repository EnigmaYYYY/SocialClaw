...
class GroupProfileMemory(BaseMemory):
    ...
    # Per-member speech style snapshots (built from user profiles)
    member_styles: Optional[List[Dict[str, Any]]] = field(default_factory=list)
