...
def create_business_app(
    ...
    # Register copilot orchestrator routes
    from copilot_orchestrator import router as copilot_router
    fastapi_app.include_router(copilot_router)
    logger.info("Copilot orchestrator routes registered")
