...
{
  "group_id": "group_123",
  "group_name": "Weekend Friends Chat",
  "message_id": "msg_001",
...
```json
{
  ...
  "description": "Friends chatting about trips and daily life",
...
| scene | string | Yes | Scene identifier (e.g., "private", "group") |
| scene_desc | object | Yes | Scene metadata |
...
| scene_desc | object | No | New scene metadata |
