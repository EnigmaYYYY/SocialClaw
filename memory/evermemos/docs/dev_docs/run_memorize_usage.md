...
- ✅ Support both `private` and `group` scenarios
...
| `--scene` | Yes | Memory extraction scenario, only supports `private` or `group` |
...
```json
{
  ...
  "conversation_meta": {
    ...
    "description": "Group chat for weekend plans",
...
Scene: private, Group ID: group_sales_ai_2025
...
### Q2: What's the difference between private and group scenarios?

A:
- **private**: One-on-one conversations (human-human or human-AI)
