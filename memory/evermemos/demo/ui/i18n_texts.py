...
class I18nTexts:
    ...
    TEXTS: Dict[str, Dict[str, str]] = {
        ...
        "scenario_assistant": {"zh": "私聊模式（人人）", "en": "Private Chat (Human-Human)"},
        "scenario_assistant_desc": {
            "zh": "一对一私聊，双方都是人，AI用于记忆检索与辅助回答",
            "en": "1:1 private chat, both participants are human; AI assists with memory retrieval and responses",
        },
        "scenario_group_chat": {"zh": "群聊模式（人人）", "en": "Group Chat (Human-Human)"},
        "scenario_group_chat_desc": {
            "zh": "多人群聊，基于群组记忆的对话辅助与分析",
            "en": "Multi-person group chat with group memory-based assistance and analysis",
        },
