...
| 场景 | 语言 | 文件名 |
|-----|------|--------|
| 私聊对话 | 中文 | `data/assistant_chat_zh.json` |
| 私聊对话 | 英文 | `data/assistant_chat_en.json` |
...
### 私聊场景 (assistant_chat_en.json / assistant_chat_zh.json)
...
- `profile_scene`: 设置为 `"private"` 或 `"group"`
